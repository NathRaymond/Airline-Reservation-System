		...
		<div class="card" >
			<div class="card-header">
				<large class="card-title">
					<b style="font-size: 20px; color:indigo;">Booked Flights List</b>
				</large>
			...
			<div class="card-body">
				<table class="table table-bordered" id="flight-list">
					...
					<thead>
						<tr>
							<th class="text-center" style="color: indigo;">S/N</th>
							<th class="text-center" style="color: indigo;">Information</th>
							<th class="text-center" style="color: indigo;">Flight Info</th>
							<th class="text-center" style="color: indigo;">Action</th>
						</tr>
					</thead>
					<tbody>
						<?php
